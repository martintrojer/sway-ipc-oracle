...
These are measurements, not scores. Each cell is pass/skip/fail; “fail” includes assertions the run did not reach. The shared `headless_xtest_boundary` family marks those assertions as not measured by the harness, not as compositor behavior. The pinned runs record both complete totals and stable-file totals. The stable counts are i3 **3,754/1/0**, sway **1,469/20/2,110**, and swayward **1,443/11/2,279**. Two complete serialized fixed-container runs found eight unstable sway files and one unstable swayward file; i3 had none. The files remain visible as `flaky` rows, and `i3/flaky-runs.toml` records per-assertion evidence. `i3/flaky.toml` names the exclusions. `contrib/validate` checks these hand-written summary figures and every table row against the TOML files.
...
| `113-urgent.t` | 64/0/0 | 21/0/43 | 18/0/46 |
...
| `141-resize.t` | 84/0/0 | 58/0/26 | 61/0/23 |
...
| `156-fullscreen-focus.t` | 64/0/0 | 1/0/63 | 1/0/63 |
...
| `165-for_window.t` | 79/0/0 | flaky | 17/0/62 |
| `166-assign.t` | 106/0/0 | 18/0/88 | 9/0/97 |
| `167-workspace_layout.t` | 87/0/0 | 9/0/78 | 40/0/47 |
...
| `173-get-marks.t` | 3/0/0 | 2/0/1 | 2/0/1 |
| `174-border-config.t` | 13/0/0 | 9/0/4 | 9/0/4 |
| `176-workspace-baf.t` | 26/0/0 | 21/0/5 | 23/0/3 |
| `177-bar-config.t` | 50/0/0 | 23/0/27 | 1/0/49 |
...
| `200-urgency-timer.t` | 12/0/0 | 11/0/1 | 8/0/4 |
...
| `211-regress-urgency-assign.t` | 3/0/0 | flaky | 1/0/2 |
...
| `219-ipc-window-focus.t` | 10/0/0 | 7/0/3 | 8/0/2 |
...
| `232-cmd-move-criteria.t` | 22/0/0 | 21/0/1 | flaky |
...
| `243-move-to-mark.t` | 50/0/0 | 38/0/12 | 3/0/47 |
| `244-new-workspace-floating-enable-center.t` | 2/0/0 | 1/0/1 | 2/0/0 |
| `245-move-position-mouse.t` | 8/0/0 | 0/0/8 | 0/0/8 |
| `246-window-decoration-focus.t` | 3/0/0 | flaky | 3/0/0 |
| `247-config-line-continuation.t` | 8/0/0 | 4/0/4 | 7/0/1 |
| `248-regress-urgency-clear.t` | 4/0/0 | flaky | 4/0/0 |
| `251-command-criteria-focused.t` | 11/0/0 | 10/0/1 | 4/0/7 |
...
| `261-match-con_id-con_mark-combinations.t` | 4/0/0 | 1/0/3 | 2/0/2 |
| `262-config-validation.t` | 2/0/0 | 1/0/1 | 1/0/1 |
| `263-config-reload-reverts-bind-mode.t` | 3/0/0 | 1/0/2 | 3/0/0 |
| `264-dock-criteria.t` | 19/0/0 | 5/0/14 | 0/0/19 |
| `265-ipc-mark.t` | 2/0/0 | 1/0/1 | 2/0/0 |
...
| `285-sticky.t` | 11/0/0 | 2/0/9 | 2/0/9 |
| `286-root-window-mouse-binding.t` | 2/0/0 | 1/0/1 | 1/0/1 |
| `287-edge-borders.t` | 31/0/0 | flaky | 22/0/9 |
| `289-ipc-shutdown-event.t` | 4/0/0 | 0/0/4 | 0/0/4 |
| `290-keypress-numlock.t` | 85/0/0 | 1/0/84 | 1/0/84 |
| `291-swap.t` | 148/0/0 | 1/0/147 | 1/0/147 |
| `292-regress-layout-toggle.t` | 1/0/0 | 1/0/0 | 1/0/0 |
| `293-focus-follows-mouse.t` | 10/0/0 | 4/0/6 | 4/0/6 |
| `293-sticky-output-crash.t` | 3/0/0 | flaky | 3/0/0 |
| `294-focus-order.t` | 61/0/0 | 1/0/60 | 0/0/61 |
| `295-net-wm-state-focused.t` | 5/0/0 | flaky | 1/0/4 |
...
| `298-ipc-misbehaving-connection.t` | 2/0/0 | 0/0/2 | 1/0/1 |
...
| `310-client-message-sticky.t` | 6/0/0 | 1/0/5 | 1/0/5 |
...
| `315-all-criterion.t` | 18/0/0 | 2/0/16 | 2/0/16 |
...
| `319-gaps.t` | 28/0/0 | 26/0/2 | 1/0/27 |
| `320-mouse-bindings.t` | 14/0/0 | 3/0/11 | 3/0/11 |
...
| `325-layout-percent-and-marks.t` | 8/0/0 | 2/0/6 | 2/0/6 |
...
| `507-workspace-move-crash.t` | 2/0/0 | 2/0/0 | 2/0/0 |
| `509-workspace_layout.t` | 2/0/0 | 1/0/1 | 1/0/1 |
| `510-focus-across-outputs.t` | 19/0/0 | 2/0/17 | 2/0/17 |
...
| `541-resize-set-tiling.t` | 32/0/0 | 24/0/8 | 27/0/5 |
...
| `550-focus-workspace.t` | 17/0/0 | 5/0/12 | 5/0/12 |
