...
swayward. The result files are raw observations. Human-reviewed reasons and citations live in
`i3/classifications/`, keyed by file and assertion, so regeneration cannot overwrite them.
...
These are measurements, not scores. Each cell is pass/skip/fail; “fail” includes assertions the run did not reach. The shared `headless_xtest_boundary` family marks those assertions as not measured by the harness, not as compositor behavior. The pinned runs record both complete totals and stable-file totals. The stable counts are i3 **3,754/1/0**, sway **1,492/20/2,171**, and swayward **446/9/3,300**. The two sway files that still vary after three pinned runs remain visible as `flaky` rows and contribute 72 additional assertions to the complete denominator; i3 and swayward had no flaky files under the same run count. `i3/flaky.toml` names the exclusions. `contrib/validate` checks these hand-written summary figures and every table row against the TOML files.

| File | i3 P/S/F | sway P/S/F | swayward P/S/F |
| --- | ---: | ---: | ---: |
| `001-tile.t` | 3/0/0 | 3/0/0 | 3/0/0 |
| `003-ipc.t` | 1/0/0 | 1/0/0 | 1/0/0 |
| `005-floating.t` | 13/0/0 | 8/0/5 | 6/0/7 |
| `100-fullscreen.t` | 79/0/0 | 17/0/62 | 21/0/58 |
| `101-focus.t` | 8/0/0 | 8/0/0 | 4/0/4 |
| `102-dock.t` | 23/0/0 | 5/0/18 | 1/0/22 |
| `104-focus-stack.t` | 2/0/0 | 1/0/1 | 2/0/0 |
| `111-goto.t` | 13/0/0 | 2/0/11 | 13/0/0 |
| `112-floating-resize.t` | 15/0/0 | 15/0/0 | 15/0/0 |
| `113-urgent.t` | 64/0/0 | 17/0/47 | 18/0/46 |
| `115-ipc-workspaces.t` | 9/0/0 | 9/0/0 | 9/0/0 |
| `116-nestedcons.t` | 7/0/0 | 4/0/3 | 4/0/3 |
| `117-workspace.t` | 92/0/0 | 34/0/58 | 47/0/45 |
| `118-openkill.t` | 6/0/0 | 2/0/4 | 2/0/4 |
| `119-match.t` | 27/0/0 | 4/0/23 | 4/0/23 |
| `120-multiple-cmds.t` | 31/0/0 | 17/0/14 | 17/0/14 |
| `121-next-prev.t` | 12/0/0 | 9/0/3 | 9/0/3 |
| `122-split.t` | 41/0/0 | 16/0/25 | 22/0/19 |
| `124-move.t` | 54/0/0 | 37/0/17 | 30/0/24 |
| `126-regress-close.t` | 1/0/0 | 1/0/0 | 1/0/0 |
| `127-regress-floating-parent.t` | 4/0/0 | 4/0/0 | 4/0/0 |
| `128-open-order.t` | 7/0/0 | 3/0/4 | 3/0/4 |
| `129-focus-after-close.t` | 15/0/0 | 8/0/7 | 8/0/7 |
| `130-close-empty-split.t` | 8/0/0 | 2/0/6 | 2/0/6 |
| `131-stacking-order.t` | 7/0/0 | 6/0/1 | 6/0/1 |
| `132-move-workspace.t` | 160/0/0 | 61/9/90 | 61/9/90 |
| `133-size-hints.t` | 16/0/0 | 9/0/7 | 0/0/16 |
| `134-invalid-command.t` | 1/0/0 | 1/0/0 | 1/0/0 |
| `135-floating-focus.t` | 82/0/0 | 4/0/78 | 3/0/79 |
| `136-floating-ws-empty.t` | 11/0/0 | 11/0/0 | 11/0/0 |
| `137-floating-unmap.t` | 2/0/0 | 1/0/1 | 1/0/1 |
| `138-floating-attach.t` | 11/0/0 | 8/0/3 | 3/0/8 |
| `139-ws-numbers.t` | 8/0/0 | 8/0/0 | 8/0/0 |
| `140-focus-lost.t` | 3/0/0 | 3/0/0 | 3/0/0 |
| `141-resize.t` | 84/0/0 | 63/0/21 | 61/0/23 |
| `142-regress-move-floating.t` | 1/0/0 | 1/0/0 | 1/0/0 |
| `143-regress-floating-restart.t` | 5/0/0 | 3/0/2 | 3/0/2 |
| `144-regress-floating-resize.t` | 1/0/0 | 0/0/1 | 0/0/1 |
| `145-flattening.t` | 8/0/0 | 7/0/1 | 8/0/0 |
| `146-floating-reinsert.t` | 3/0/0 | 1/0/2 | 1/0/2 |
...
| `154-regress-multiple-dock.t` | 2/0/0 | 2/0/0 | 1/0/1 |
| `155-floating-split-size.t` | 4/0/0 | 2/0/2 | 2/0/2 |
| `156-fullscreen-focus.t` | 64/0/0 | 1/0/63 | 0/0/64 |
| `159-socketpaths.t` | 8/0/0 | 0/0/8 | 0/0/8 |
| `161-regress-borders-restart.t` | 4/0/0 | 2/0/2 | 0/0/4 |
| `162-regress-dock-urgent.t` | 4/0/0 | 2/0/2 | 0/0/4 |
| `164-kill-win-vs-client.t` | 12/0/0 | 3/0/9 | 0/0/12 |
| `165-for_window.t` | 79/0/0 | 19/0/60 | 0/0/79 |
| `166-assign.t` | 106/0/0 | 18/0/88 | 0/0/106 |
| `167-workspace_layout.t` | 87/0/0 | 11/0/76 | 0/0/87 |
| `168-regress-fullscreen-restart.t` | 1/0/0 | 1/0/0 | 0/0/1 |
| `169-border-toggle.t` | 20/0/0 | 0/0/20 | 0/0/20 |
| `170-force_focus_wrapping.t` | 12/0/0 | 9/0/3 | 0/0/12 |
| `172-start-on-named-ws.t` | 7/0/0 | 6/0/1 | 0/0/7 |
| `173-get-marks.t` | 3/0/0 | 2/0/1 | 0/0/3 |
| `174-border-config.t` | 13/0/0 | 9/0/4 | 0/0/13 |
| `176-workspace-baf.t` | 26/0/0 | 21/0/5 | 0/0/26 |
| `177-bar-config.t` | 50/0/0 | 23/0/27 | 0/0/50 |
| `178-regress-workspace-open.t` | 1/0/0 | 1/0/0 | 0/0/1 |
...
| `185-scratchpad.t` | 100/0/0 | 2/0/98 | 0/0/100 |
| `186-regress-assign-focus-parent.t` | 8/0/0 | 8/0/0 | 0/0/8 |
| `187-commands-parser.t` | 25/0/0 | 0/0/25 | 0/0/25 |
| `188-regress-focus-restart.t` | 11/0/0 | 11/0/0 | 0/0/11 |
| `189-floating-constraints.t` | 28/0/0 | 24/0/4 | 0/0/28 |
| `190-scratchpad-diff-ws.t` | 3/0/0 | 3/0/0 | 0/0/3 |
| `191-resize-levels.t` | 3/0/0 | 2/0/1 | 0/0/3 |
| `192-layout.t` | 34/0/0 | 22/0/12 | 0/0/34 |
| `193-ipc-version.t` | 4/0/0 | 3/0/1 | 0/0/4 |
| `194-regress-floating-size.t` | 15/0/0 | 15/0/0 | 0/0/15 |
| `196-randr-output-names.t` | 1/0/0 | 1/0/0 | 1/0/0 |
| `197-regression-move-vanish.t` | 4/0/0 | 4/0/0 | 0/0/4 |
...
| `202-scratchpad-criteria.t` | 27/0/0 | 8/0/19 | 0/0/27 |
...
| `206-fullscreen-scratchpad.t` | 8/0/0 | 4/0/4 | 0/0/8 |
...
| `219-ipc-window-focus.t` | 10/0/0 | 7/0/3 | 0/0/10 |
...
| `227-ipc-workspace-empty.t` | 3/0/0 | 0/0/3 | 0/0/3 |
| `228-border-widths.t` | 21/0/0 | 18/0/3 | 0/0/21 |
| `231-ipc-floating-event.t` | 2/0/0 | 1/0/1 | 0/0/2 |
| `232-cmd-move-criteria.t` | 22/0/0 | flaky | 0/0/22 |
| `233-regress-manage-focus-unmapped.t` | 2/0/0 | 1/0/1 | 0/0/2 |
| `235-check-config-no-x.t` | 8/0/0 | 8/0/0 | 8/0/0 |
...
| `240-focus-on-window-activation.t` | 15/0/0 | 13/0/2 | 0/0/15 |
| `241-consistent-center.t` | 12/0/0 | 7/0/5 | 0/0/12 |
| `242-no-focus.t` | 6/0/0 | 6/0/0 | 0/0/6 |
| `243-move-to-mark.t` | 50/0/0 | flaky | 0/0/50 |
| `244-new-workspace-floating-enable-center.t` | 2/0/0 | 1/0/1 | 0/0/2 |
...
| `252-floating-size.t` | 49/0/0 | 40/0/9 | 0/0/49 |
| `254-move-to-output-with-criteria.t` | 16/0/0 | 3/6/7 | 0/0/16 |
| `255-multiple-marks.t` | 9/0/0 | 9/0/0 | 0/0/9 |
| `256-no-auto-back-and-forth.t` | 10/0/0 | 8/0/2 | 0/0/10 |
| `257-keypress-group1-fallback.t` | 17/0/0 | 1/0/16 | 0/0/17 |
| `258-keypress-release.t` | 49/0/0 | 1/0/48 | 0/0/49 |
| `260-invalid-criteria.t` | 2/0/0 | 1/0/1 | 0/0/2 |
| `261-match-con_id-con_mark-combinations.t` | 4/0/0 | 1/0/3 | 0/0/4 |
| `262-config-validation.t` | 2/0/0 | 1/0/1 | 1/0/1 |
| `263-config-reload-reverts-bind-mode.t` | 3/0/0 | 1/0/2 | 0/0/3 |
| `264-dock-criteria.t` | 19/0/0 | 5/0/14 | 0/0/19 |
| `265-ipc-mark.t` | 2/0/0 | 1/0/1 | 0/0/2 |
| `266-net-moveresize-window.t` | 12/0/0 | 0/0/12 | 0/0/12 |
| `267-regress-mark-restart.t` | 1/0/0 | 1/0/0 | 0/0/1 |
| `268-ipc-config.t` | 2/0/0 | 1/0/1 | 1/0/1 |
| `269-focus-stack-above.t` | 5/0/0 | 3/0/2 | 0/0/5 |
| `270-config-no-newline-end.t` | 2/0/0 | 2/0/0 | 0/0/2 |
| `271-for_window_tilingfloating.t` | 20/0/0 | 8/0/12 | 0/0/20 |
...
| `277-ipc-window-urgent.t` | 2/0/0 | 0/0/2 | 0/0/2 |
| `279-regress-default-floating-border.t` | 1/0/0 | 0/0/1 | 0/0/1 |
| `280-wm-class-change-handler.t` | 4/0/0 | 3/0/1 | 0/0/4 |
| `281-regress-reload-bindsym.t` | 1/0/0 | 1/0/0 | 0/0/1 |
| `282-tabbed-floating-disable-crash.t` | 1/0/0 | 1/0/0 | 0/0/1 |
| `284-ewmh-visible-name.t` | 5/0/0 | 0/0/5 | 0/0/5 |
| `285-sticky.t` | 11/0/0 | 2/0/9 | 0/0/11 |
| `286-root-window-mouse-binding.t` | 2/0/0 | 1/0/1 | 0/0/2 |
| `287-edge-borders.t` | 31/0/0 | 29/0/2 | 0/0/31 |
| `289-ipc-shutdown-event.t` | 4/0/0 | 0/0/4 | 0/0/4 |
| `290-keypress-numlock.t` | 85/0/0 | 1/0/84 | 1/0/84 |
| `291-swap.t` | 148/0/0 | 1/0/147 | 0/0/148 |
| `292-regress-layout-toggle.t` | 1/0/0 | 1/0/0 | 0/0/1 |
| `293-focus-follows-mouse.t` | 10/0/0 | 4/0/6 | 0/0/10 |
| `293-sticky-output-crash.t` | 3/0/0 | 2/0/1 | 0/0/3 |
| `294-focus-order.t` | 61/0/0 | 1/0/60 | 0/0/61 |
| `295-net-wm-state-focused.t` | 5/0/0 | 3/0/2 | 0/0/5 |
| `296-regress-focus-behind-fullscreen-floating.t` | 1/0/0 | 1/0/0 | 0/0/1 |
| `297-assign-workspace-to-output.t` | 25/0/0 | 13/0/12 | 0/0/25 |
| `297-scroll-tabbed.t` | 16/0/0 | 1/0/15 | 1/0/15 |
| `298-ipc-misbehaving-connection.t` | 2/0/0 | 1/0/1 | 0/0/2 |
| `299-regress-scratchpad-focus.t` | 1/0/0 | 1/0/0 | 0/0/1 |
| `301-shape.t` | 4/0/0 | 1/0/3 | 0/0/4 |
| `302-tree.t` | 15/0/0 | 0/0/15 | 0/0/15 |
| `303-regress-move-floating.t` | 3/0/0 | 1/0/2 | 0/0/3 |
| `304-ipc-workspace-init.t` | 9/0/0 | 9/0/0 | 0/0/9 |
| `306-move-to-parent.t` | 2/0/0 | 0/0/2 | 0/0/2 |
| `307-focus-next-prev.t` | 9/0/0 | 0/0/9 | 0/0/9 |
| `308-focus_wrapping.t` | 32/0/0 | 0/0/32 | 0/0/32 |
| `309-crash-move-parent.t` | 2/0/0 | 0/0/2 | 0/0/2 |
| `310-client-message-sticky.t` | 6/0/0 | 1/0/5 | 0/0/6 |
...
| `315-all-criterion.t` | 18/0/0 | 2/0/16 | 0/0/18 |
| `315-long-commands.t` | 4/0/0 | 3/0/1 | 0/0/4 |
| `316-drag-container.t` | 18/0/0 | 1/0/17 | 1/0/17 |
| `316-transient-for-loop.t` | 1/0/0 | 1/0/0 | 0/0/1 |
| `317-bar-config-font-fallback.t` | 1/0/0 | 0/0/1 | 0/0/1 |
| `317-bar-config-font-order.t` | 1/0/0 | 0/0/1 | 0/0/1 |
| `317-bar-output-trailing-space.t` | 4/0/0 | 4/0/0 | 0/0/4 |
| `319-gaps.t` | 28/0/0 | 26/0/2 | 0/0/28 |
| `320-mouse-bindings.t` | 14/0/0 | 3/0/11 | 0/0/14 |
...
| `325-layout-percent-and-marks.t` | 8/0/0 | 2/0/6 | 0/0/8 |
| `500-multi-monitor.t` | 1/0/0 | 0/0/1 | 0/0/1 |
| `501-scratchpad.t` | 44/0/0 | 44/0/0 | 0/0/44 |
| `502-focus-output.t` | 19/0/0 | 19/0/0 | 0/0/19 |
| `503-workspace.t` | 18/0/0 | 3/0/15 | 0/0/18 |
| `504-move-workspace-to-output.t` | 31/0/0 | 9/0/22 | 0/0/31 |
| `505-scratchpad-resolution.t` | 90/0/0 | 45/0/45 | 0/0/90 |
| `506-focus-right.t` | 31/0/0 | 28/0/3 | 0/0/31 |
| `507-workspace-move-crash.t` | 2/0/0 | 2/0/0 | 0/0/2 |
| `509-workspace_layout.t` | 2/0/0 | 1/0/1 | 0/0/2 |
| `510-focus-across-outputs.t` | 19/0/0 | 2/0/17 | 0/0/19 |
| `511-scratchpad-configure-request.t` | 2/0/0 | 2/0/0 | 0/0/2 |
| `512-move-wraps.t` | 10/0/0 | 6/2/2 | 0/0/10 |
| `513-move-workspace.t` | 6/0/0 | 2/0/4 | 0/0/6 |
| `514-ipc-workspace-multi-monitor.t` | 4/0/0 | 3/0/1 | 0/0/4 |
| `515-create-workspace.t` | 2/0/0 | 2/0/0 | 0/0/2 |
| `516-move.t` | 14/0/0 | 8/0/6 | 0/0/14 |
...
| `520-regress-focus-direction-floating.t` | 1/0/0 | 0/0/1 | 0/0/1 |
| `522-rename-assigned-workspace.t` | 9/0/0 | 3/0/6 | 0/0/9 |
| `523-move-position-center.t` | 4/0/0 | 4/0/0 | 0/0/4 |
| `524-move.t` | 38/0/0 | 29/0/9 | 0/0/38 |
| `526-reconfigure-dock.t` | 3/0/0 | 0/0/3 | 0/0/3 |
| `527-focus-fallback.t` | 2/0/0 | 1/0/1 | 0/0/2 |
| `528-workspace-next-prev-reversed.t` | 38/0/0 | 3/0/35 | 0/0/38 |
| `530-bug-2229.t` | 1/0/0 | 1/0/0 | 0/0/1 |
| `531-fullscreen-on-given-output.t` | 4/0/0 | 2/0/2 | 0/0/4 |
| `534-dont-warp.t` | 2/0/0 | 2/0/0 | 0/0/2 |
| `535-workspace-next-prev.t` | 38/0/0 | 3/0/35 | 0/0/38 |
| `537-move-single-to-output.t` | 8/0/0 | 8/0/0 | 0/0/8 |
| `538-i3bar-primary-output.t` | 4/0/0 | 4/0/0 | 0/0/4 |
| `539-disable_focus_wrapping.t` | 10/0/0 | 10/0/0 | 0/0/10 |
| `540-sigterm-cleanup.t` | 2/0/0 | 2/0/0 | 0/0/2 |
| `541-resize-set-tiling.t` | 32/0/0 | 27/0/5 | 0/0/32 |
| `543-move-workspace-to-multiple-outputs.t` | 63/0/0 | 14/0/49 | 0/0/63 |
| `544-focus-multiple-outputs.t` | 41/0/0 | 8/0/33 | 0/0/41 |
| `545-i3-registration.t` | 1/0/0 | 1/0/0 | 0/0/1 |
| `546-empty-bindcommand.t` | 1/0/0 | 1/0/0 | 0/0/1 |
| `547-explicit-mode-default.t` | 1/0/0 | 1/0/0 | 0/0/1 |
| `547-nested-variables.t` | 2/0/0 | 2/0/0 | 0/0/2 |
| `549-focus-wrapping-gaps.t` | 2/0/0 | 2/0/0 | 0/0/2 |
| `550-focus-workspace.t` | 17/0/0 | 5/0/12 | 0/0/17 |
| `550-split-redundant-containers.t` | 8/0/0 | 0/0/8 | 0/0/8 |
| `551-net-wm-state-maximized.t` | 12/0/0 | 1/0/11 | 0/0/12 |
| `553-popup_during_fullscreen.t` | 20/0/0 | 16/0/4 | 1/0/19 |
| `554-commands-crash-for-window.t` | 101/0/0 | 67/0/34 | 0/0/101 |
| `556-workspace-keeps-focus-after-move.t` | 5/0/0 | 1/0/4 | 0/0/5 |
